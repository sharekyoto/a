...
## 7. 未完了・次の候補
1. **lazyweb デザイン刷新**(現タスク): **方向=「大胆ポップ(Z世代・キャッチー)」**(オーナー決定)。鮮やかな色・大きな丸ゴシック見出し・丸み・軽いモーション・ポップなボタン/チップ。SNS的な勢いで高校生にキャッチー。機能(4つの探し方・成長メーター・About・深掘りリンク・初動高速化)を壊さないこと。1ファイルCSS完結・CDNのみ・localStorage不可・モバイル優先。
