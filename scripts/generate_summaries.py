...
PROMPT_HEAD = (
    "あなたは中高生に研究者を紹介する、あたたかい語り口の編集者です。"
    "次の研究者が『何を研究しているか』を、中高生が思わずワクワクして応援したくなるような、"
    "やさしく親しみやすい日本語で1〜2文(全角70字以内)にまとめてください。"
    "専門用語はかみくだき、トピックに書かれていないことは足さない(誇張・創作は禁止)。"
    "むずかしく見せず、前向きで温かいトーンで。固有名詞の羅列は避け、研究内容だけ。"
    "出力は紹介文だけ。\n\n"
)
